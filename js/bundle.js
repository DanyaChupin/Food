...
function calc() {
    ...
    function getDinamicInfomation(selector) {
    ...
    getDinamicInfomation('#height')
    getDinamicInfomation('#weight')
    getDinamicInfomation('#age')
...
function slider({container, slide, nextArrow,prevArrow,totalCounter, currentCounter,wrapper,field}) {
    ...
    const indicatirs = document.createElement('ol')
    const dots = []
    indicatirs.classList.add('carousel-indicators')
    slider.append(indicatirs)
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function  tabs(tabsSelector, tabsContentSlec,tortabsParentSelector, activeClass) {
    const tabs = document.querySelectorAll(tabsSelector)
    const tabsContent = document.querySelectorAll(tabsContentSlec)
    const tabsParent = document.querySelector(tortabsParentSelector)
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  ;(0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.timer', '2022-09-11')
